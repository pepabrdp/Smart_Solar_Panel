...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA0-WKUP     ------> ADC1_IN0
    */
    HAL_GPIO_DeInit(Voltage_Divider_GPIO_Port, Voltage_Divider_Pin);
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB9     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(GPS_and_MAG_I2C_SCL_GPIO_Port, GPS_and_MAG_I2C_SCL_Pin);

    HAL_GPIO_DeInit(GPS_and_MAG_I2C_SDA_GPIO_Port, GPS_and_MAG_I2C_SDA_Pin);
  ...
  /* USER CODE END I2C3_MspDeInit 0 */
    ...
    PA8     ------> I2C3_SCL
    */
    HAL_GPIO_DeInit(I2C_Light_SDA_GPIO_Port, I2C_Light_SDA_Pin);

    HAL_GPIO_DeInit(I2C_Light_SCL_GPIO_Port, I2C_Light_SCL_Pin);
